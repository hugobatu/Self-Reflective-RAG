...
def transform_hotpotqa_to_documents(dataset_path: str):
    """Load and transforming into List[Document] in LangChain."""
...
# print(f"Transformed and created {len(docs_to_index)} docs")